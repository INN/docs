...
- **Create/activate all accounts** - Your supervisor will be creating accounts for you. We have [a list of them here](/staffing/onboarding/accounts.md). If you run into anything that's not on the list, add it.
...
- **Schedule meetings with all INN staff members** - In your first couple of weeks you'll want to spend a little time with each INN staff member (not just our immediate team) to get to know them, their role with the organization and how your work might overlap. The complete staff list can be found in [the staff directory](https://docs.google.com/document/d/1OFMDAbyjgfQSm9qbD8nogyGaL33ea-0tNLO9-P6DFfU/edit). If you need help making those connections, just ask.
- **Collect your notes and thoughts**, reflect on your first week and write a blog post on the [team blog](http://labs.inn.org) about what you've learned.
